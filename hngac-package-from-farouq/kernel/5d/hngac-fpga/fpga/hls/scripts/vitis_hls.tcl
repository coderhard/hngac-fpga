...
# Top function lives at file scope in hngac_kernel.cpp, matching the 4D
# hardware/cosim flow. Vitis 2025.2 co-sim previously failed to generate a
# matching stub for a namespaced top.
...
# ---------------------------------------------------------------------------
# C simulation — runs the 5D testbench through the HLS compiler
# ---------------------------------------------------------------------------
csim_design
