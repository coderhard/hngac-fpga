...
In software, the same added dimension makes every policy rule 19\% more expensive. The two added dimensions cost 1{,}336 LUTs and no BRAM or DSP. With 5D H-NGAC, robotics and functional-safety engineers can add runtime state and command provenance to the control path without spending a clock cycle.
\end{abstract}
