...
\IEEEauthorrefmark{3}Florida International University \quad
\IEEEauthorrefmark{4}Zetafence, Inc. \quad
\IEEEauthorrefmark{5}Texas A\&M University - Central Texas}
}
% Faruque affiliation corrected 2026-08-07 evening: his LinkedIn and
% ResearchGate both say NMSU (Klipsch ECE, the TrojanWhisper/GHOST group);
% FIU had come from an assumption, not from Omar. CONFIRM in his reply to the
% review email. Badawy stays FIU per his Scholar profile (verified fiu.edu).
